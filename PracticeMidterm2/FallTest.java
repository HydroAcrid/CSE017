...
public class FallTest {
    public static void main(String[] args) {
		...
		splitCollection(c, "Florida", subL1, subL2, c.iterator());
		...
		subL1.clear();
		subL2.clear();
		splitCollection(c, "Arkansas", subL1, subL2, c.iterator());
		System.out.println("First part of the collection:");
		printCollection(subL1);
	...
	*/
	...
	private static <E> void combineNoDuplicates(Iterator<E> iterator, Collection<E> c1) { //O(n)^2
        ...
        if (iterator.hasNext()) {
            ...
            combineNoDuplicates(iterator, c1);
        }
	}
	/*
	...
	*/
	public static <E,T> void splitCollection(Collection<E> c, E delimiter, Collection<E> c1, Collection<E> c2, Iterator<E> iter){

		iter = c.iterator();
		String<E> swag = c..Split(delimiter);
    ...
    public static<E> boolean search(Collection<E> c, E item) {
        Iterator<E> iter = c.iterator();
        return search(iter, item);
    }

    public static <E>  boolean search(Iterator<E> iter, E item) {
