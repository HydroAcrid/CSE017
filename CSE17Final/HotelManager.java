...
public class HotelManager {
	...
	private void readStaff(String filename) {
		...
		// 		Staff person;
		// 		person.setPassword(items[1]);
        //         staff.put(items[0], person.getPassword());
        //     }
        //     read.close();
        // } 
        // catch(FileNotFoundException e){
	...
	public void printGuestInvoice(Guest g) {
		System.out.println("Room #: " + g.getRooms());
		System.out.println("Price: " + g.getPayment());		
	}
	/**
